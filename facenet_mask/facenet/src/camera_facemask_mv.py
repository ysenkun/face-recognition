...
#save video
#cap = cv2.VideoCapture('/Users/sen/Documents/facetime.mp4')
        ...
        with tf.Session() as sess:
            ...
            while True:
                ...
                for num,images in enumerate(images_list):
                    ...
                    #save video
                    # detect_name = 'sentaro_yoshida'
                    # print(box_list[num])
                    # x_1 = int(box_list[num][0])
                    # y_1 = int(box_list[num][1])
                    # x_2 = int(box_list[num][2])
                    # y_2 = int(box_list[num][3])

                    # cv2.rectangle(frame,(x_1,y_1),(x_2,y_2),(255,255,255),thickness=2)
